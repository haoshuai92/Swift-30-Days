...
class SecondTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        tableView.register(FirstTableViewCell.self, forCellReuseIdentifier: "SecondTableViewCellIdentifier")
    }
    ...
    func animateTable() {
        ...
        for (index, cell) in cells.enumerated(){
            ...
            UIView.animate(withDuration: 1.0, delay: 0.05*Double(index), usingSpringWithDamping: 1, initialSpringVelocity: 1.0, options: [], animations: {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "SecondTableViewCellIdentifier") as! FirstTableViewCell
