...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        refreshContrl.backgroundColor = UIColor.clear
        refreshContrl.tintColor = UIColor.clear
        tableView.addSubview(refreshContrl)
        loadCustomRefreshContents()
    }
    
    func loadCustomRefreshContents() {
        customView = Bundle.main.loadNibNamed("RefreshContents", owner:self, options: nil)![0] as? UIView
        customView.frame = refreshContrl.bounds
        
        for i in 0..<customView.subviews.count {
            labelsArray.append(customView.viewWithTag(i+1) as! UILabel)
        }
        
        refreshContrl.addSubview(customView)
            ...
            self.labelsArray[11].transform = scale
                ...
                UIView.animate(withDuration: 0.25, delay: 0.0, options: .curveLinear, animations: {
                    ...
                    self.labelsArray[11].transform = .identity
                        ...
                        if self.refreshContrl.isRefreshing {
